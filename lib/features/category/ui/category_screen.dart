          ...
          child: Column(
            ...
            children: [
              ...
              if (categoryId != null)
                Expanded(
                  child: selectedTab == 0 ?
                  _buildPaginatedTab<ActivityDetailsModel>(
                    onCubitCreated: (cub) => cubit = cub,
                    repositoryCallBack: (model) {
                      return AllActivitiesUseCase(CategoryRepository())
                          .call(params: AllActivitiesParams(model,
                        categoryId: categoryId!,price: priceOrder?.value,rate: rateOrder?.value));
                    },
                    itemBuilder: (item) => HomeItem(activity: item)
