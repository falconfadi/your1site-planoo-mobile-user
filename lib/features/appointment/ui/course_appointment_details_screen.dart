            ...
            child: Column(
              children: [
                AppointmentItemWidget(
                    onTap: () {
                      Navigation.push(CourseDetailsScreen(courseId: model.iD!));
                    },
                    ...
                    price: "${model.price} ${AppLocalization.of(context).translate("syr")}"
                ),
                  ...
                  child: Container(
                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        SizedBox(height: 10.h),
                        IconTextWidget(
                          icon: image.remainingSessions,
                          iconSize: 25.sp,
                          text: "${model.customer!.remainingSessions!} (${AppLocalization.of(context).translate("remaining_sessions")})",
                          textStyle: AppTheme.labelLarge.copyWith(color: AppColors.primaryColor),
                        ),
                      ],
                    ),
                  ),
